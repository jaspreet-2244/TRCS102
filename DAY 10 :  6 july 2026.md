...
import pandas as pd
import numpy as np
GlobalCountries=["India","USA","Nepal","Sri Lanka"]
s_countries=pd.Series(GlobalCountries)
display(s_countries)
df=pd.read_csv("DataSet_used/bollywood.csv")
display(df.head())
movies = pd.Series(index=df['movie'])
display(movies)
data = {
    'Name': ['Alice', 'Bob', 'Charlie', 'David', 'Eve'],
    'Age': [24, 27, 22, 32, 29],
...
df_demo.head()
print("Extracting Alice Infromation Using loc: ")
alice_loc = df_demo.loc[0, ['Age', 'Score']]
print(alice_loc)
print("extracting Alice information using iloc:")
alice_iloc = df_demo.iloc[0:4, [-2,-1]]
print(alice_iloc)
```
<img width="355" height="678" alt="image" src="https://github.com/user-attachments/assets/5a0eab3c-ff30-43b6-b1e6-25e659b37ee7" />
...
```
--- Original DataFrame ---
   Employee Department  Salary  Experience (Years)  Performance_Score
0    Alice         HR   50000                   2                 85
1      Bob         IT   70000                   5                 92
2  Charlie         IT   65000                   4                 88
3    David         HR   55000                   3                 75
4      Eve    Finance   80000                   7                 95
5    Frank    Finance   75000                   6                 80

--- Column Selection ---
Single Column (Series):
 0    Alice
1      Bob
Name: Employee, dtype: str
...
2  Charlie         IT   65000                   4                 88
3    David         HR   55000                   3                 75
Experience between 3 and 5 years:
   Employee Department  Salary  Experience (Years)  Performance_Score
1      Bob         IT   70000                   5                 92
2  Charlie         IT   65000                   4                 88
3    David         HR   55000                   3                 75
...
Multiple Aggregations:
              Salary         Performance_Score
               mean     sum               max
Department                                   
Finance     77500.0  155000                95
HR          52500.0  105000                85
IT          67500.0  135000                92
